        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex">
            <input
              ...
              className="px-4 py-2 border border-gray-300 rounded-l-md focus:outline-none focus:border-red-850"
            />
            <button
              onClick={handleSearch}
              className="px-4 py-2 bg-red-850 text-white rounded-r-md hover:bg-indigo-600 focus:outline-none focus:bg-indigo-600"
            >
              Search
            </button>
          </div>
          <button
            ...
            className="px-4 py-2 bg-red-850 text-white rounded-md hover:bg-indigo-600 focus:outline-none focus:bg-indigo-600"
          >
            Add Product
          </button>
        </div>
