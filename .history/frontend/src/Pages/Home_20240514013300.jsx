...
const Home = () => {
  ...
  return (
    <div className="w-max flex justify-center items-center h-screen">
      <div className=" rounded-lg overflow-hidden shadow-lg bg-gradient-to-br from-gray-500 to-gray-600">
        <div className="flex flex-col items-center mt-8">
          ...
          <div className="mb-4 flex items-center">
            ...
            <button
              ...
              className="px-4 py-2 bg-indigo-500 text-white rounded-md focus:outline-none focus:bg-indigo-600"
            >
              Add
            </button>
            <button
