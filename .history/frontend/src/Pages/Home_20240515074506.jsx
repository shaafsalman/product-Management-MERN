      ...
      <tr key={index} className={"bg-transparent "}>
        ...
        <td className="px-6 py-4 space-x-2 flex justify-center">
          <button
            ...
            className="px-4 py-2 bg-blue-800 text-white rounded-md hover:bg-indigo-700 focus:outline-none focus:bg-indigo-700 transition duration-300"
          >
            Update
          </button>
          <button
            onClick={() => handleDeleteProduct(product._id)}
            className="px-4 py-2 bg-red-9500 text-white rounded-md hover:bg-purple-700 focus:outline-none focus:bg-purple-700 transition duration-300"
          >
            Delete
          </button>
        </td>
