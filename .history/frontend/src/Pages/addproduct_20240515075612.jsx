      ...
      <div className="max-w-md w-full p-6 bg-gray-100 rounded-lg shadow-lg">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col">
          ...
          <div className="flex justify-end">
            ...
            <button type="submit" className="w-full bg-gray-600 text-white py-2 rounded-md font-semibold hover:bg-gray-600 hover:text-white transition duration-300">Add</button>
          </div>
        </form>
      </div>
    </div>
