...
import MessageCard from './../Cards/MessageCard'; // Import the MessageCard component
...
const AddProduct = ({ onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      onClose();
      setMessage({ Heading: 'Success', Message: 'Product added successfully!' }); // Set success message
    } catch (error) {
      console.error('Error adding product:', error);
      setMessage({ Heading: 'Error', Message: 'Failed to add product' }); // Set error message
    }
  };
  ...
  return (
    <>
      ...
      {message && <MessageCard Heading={message.Heading} Message={message.Message} onClose={() => setMessage({})} />} {/* Render MessageCard if message is present */}
    </>
  );
};
