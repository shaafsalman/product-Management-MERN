...
const Home = () => {
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex">
            ...
            <button
              ...
              className="px-4 py-2 bg-red-950 text-white rounded-r-md hover:bg-red-800 focus:outline-none focus:bg-red-800"
            >
              Search
            </button>
          </div>
          <button
            onClick={showAdd}
            className="px-4 py-2 bg-red-950 text-white rounded-md hover:bg-red-800 focus:outline-none focus:bg-red-800"
          >
            Add Product
          </button>
        </div>
  ...
  <thead>
    <tr className="bg-gradient-to-r from-red-950 to-red-900 text-white">
      ...
      <tr key={index} className={"bg-transparent "}>
        ...
        <td className="px-6 py-4 space-x-2 flex justify-center">
          <button
            ...
            className="px-4 py-2 mr-5 bg-blue-800 text-white rounded-md hover:bg-blue-700 focus:outline-none focus:bg-red-700 transition duration-300"
          >
            Update
          </button>
          <button
            onClick={() => handleDeleteProduct(product._id)}
            className="w-full bg-gray-600 text-white py-2 rounded-md font-semibold hover:bg-white hover:text-gray-600 hover:radius-gray-600 transition duration-300"
          >
            Delete
          </button>
        </td>
