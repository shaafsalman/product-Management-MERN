        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex">
            ...
            <button
              ...
              className="px-4 py-2 bg-indigo-500 text-white rounded-r-md hover:bg-red-800 focus:outline-none focus:bg-red-800"
            >
              Search
            </button>
          </div>
          <button
            onClick={showAdd}
            className="px-4 py-2 bg-indigo-500 text-white rounded-md hover:bg-red-800 focus:outline-none focus:bg-red-800"
          >
            Add Product
          </button>
        </div>
      ...
      <tr key={index} className={"bg-transparent "}>
        ...
        <td className="px-6 py-4 space-x-2 flex justify-center">
          <button
            ...
            className="px-4 py-2 bg-red-800 text-white rounded-md hover:bg-indigo-700 focus:outline-none focus:bg-indigo-700 transition duration-300"
          >
            Update
          </button>
          <button
