  ...
  <tbody>
    {searchResults.map((product, index) => (
      <tr key={index} className={(index % 2 === 0) ? "bg-gray-100" : "bg-gray-200"}>
        <td className="px-6 py-4 text-left text-gray-900">{product.name}</td>
        <td className="px-6 py-4 text-left text-gray-900">{product.price}</td>
        <td className="px-6 py-4 flex justify-center space-x-4">
          ...
          <button
            ...
            className="px-4 py-2 bg-red-600 text-white rounded-md hover:bg-red-700 focus:outline-none focus:bg-red-700 transition duration-300"
          >
            Delete
          </button>
        </td>
