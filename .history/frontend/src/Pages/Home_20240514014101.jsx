...
const Home = () => {
  ...
  return (
    <div className="flex justify-center  min-h-screen bg-gradient-to- ">
      <div className="max-w-screen-md w-full br from-slate-700 to-slate-400 shadow-lg rounded-lg p-8">
